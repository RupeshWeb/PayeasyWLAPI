...
namespace Paytm
{
    public class Paytm
    {
        ...
        public TransactionResponse DoTransaction(string accountNumber, string IFSC, string accountType, string mobile, string accountHolderName, string amount, string orderID)
        {
            JavaScriptSerializer jSerializer = new JavaScriptSerializer();
            string response = SendPaytmRequest(accountNumber, IFSC, accountType, mobile, accountHolderName, amount, orderID);
